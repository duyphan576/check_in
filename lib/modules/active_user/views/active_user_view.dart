...
class ActiveUserView extends GetView<ActiveUserController> with CacheManager {
  ActiveUserView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ActiveUserController>(
      builder: (controller) {
        return Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    _CodeEditText(
                                        hintText: ActiveUserString.HINT_CODE,
                                        userNameController:
                                            controller.codeController),
                                    GlobalStyles.sizedBoxHeight,
                                    _PasswordEditText(
                                      hintText: ActiveUserString.HINT_PASSWORD,
                                      passwordController:
                                    ...
                                    Obx(
                                      () => Container(
                                        ...
                                        child: controller.isNewUser.value
                                            ? RememberPass()
                                            : _BiometricActiveUser(),
                                      ),
                                    ),
                                    GlobalStyles.sizedBoxHeight,
                                    InkWell(
                                      onTap: () async {
                                        controller.onActiveUser();
                                      },
                                      child: Container(
                                        width:
...
class _CodeEditText extends GetView<ActiveUserController> {
  const _CodeEditText(
...
class _PasswordEditText extends GetView<ActiveUserController> {
...
class RememberPass extends GetView<ActiveUserController> {
  @override
  Widget build(BuildContext context) {
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(
                    ActiveUserString.REMEMBER_TEXT,
                    style: TextStyle(
              ...
              Material(
                ...
                child: InkWell(
                  ...
                  child: Text(
                    ActiveUserString.FORGOT_PASSWORD,
                    style: TextStyle(
                      color: AppColors.main,
                      fontWeight: FontWeight.bold,
                    ),
...
class _BiometricActiveUser extends GetView<ActiveUserController> {
  const _BiometricActiveUser({Key? key}) : super(key: key);
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      onTap: () => controller.biometricActiveUser(),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          Image.asset(
